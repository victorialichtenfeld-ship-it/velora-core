...
export function HowItWorks() {
  return (
    <section id="how" className="mx-auto w-full max-w-6xl px-4 py-20 sm:px-6">
      <p className="text-xs uppercase tracking-[0.2em] text-primary">How Velora works</p>
          ...
          <svg viewBox="0 0 640 112" className="h-full w-full">
            <defs>
              <linearGradient id="flow" x1="0" x2="1">
                <stop stopColor="#1F6F68" stopOpacity="0.2" />
                <stop offset="0.5" stopColor="#1F6F68" />
                <stop offset="1" stopColor="#1F6F68" stopOpacity="0.2" />
              </linearGradient>
            </defs>
            <path
              d="M20 56 H620"
            ...
            />
            <circle cx="320" cy="56" r="22" fill="#FFFDF8" stroke="#1F6F68" strokeWidth="1.6" />
            <circle cx="320" cy="56" r="7" fill="#1F6F68" />
          </svg>
        </div>
        <div className="mt-1 text-center text-sm text-primary">Velora</div>
