    ...
    <div className="h-64 w-full min-w-0">
      <ResponsiveContainer width="100%" height="100%">
        <AreaChart data={riskTrend}>
          ...
          <CartesianGrid stroke="rgba(246,241,230,0.08)" vertical={false} />
          <XAxis dataKey="day" stroke="#b8b0a0" fontSize={12} tickLine={false} axisLine={false} />
          <YAxis stroke="#b8b0a0" fontSize={12} tickLine={false} axisLine={false} />
    ...
    <div className="h-64 w-full min-w-0">
      <ResponsiveContainer width="100%" height="100%">
        <BarChart data={riskByType} layout="vertical" margin={{ left: 24 }}>
          <CartesianGrid stroke="rgba(246,241,230,0.08)" horizontal={false} />
          ...
          />
          <Tooltip contentStyle={tooltipStyle} />
          <Bar dataKey="value" fill="#C4A35A" radius={[0, 8, 8, 0]} />
        </BarChart>
      </ResponsiveContainer>
    </div>
  );
